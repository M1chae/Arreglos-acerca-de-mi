function saludar(){
    const nombre=[];
    nombre[0] = prompt ("Escribe tu nombre")
    nombre[1] = prompt ('Escribe tu apellido')
    nombre[2] = prompt ("Escribe tu edad")
    nombre[3] = "Hola"

    document.getElementById('saludar').innerHTML=nombre[0]+ " " +nombre[1]+ " " +nombre[2]+" " +nombre[3];    
}
